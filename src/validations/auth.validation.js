...
const register = {
  ...
  body:Joi.object().keys({
    ...
    password: Joi.string().required().custom(password),   // Use the custom validation correctly
...
const login = {
  ...
  body: Joi.object().keys({
    email: Joi.string().email().required(),
    password: Joi.string().required()  // Password validation is handled in the login controller
  })
